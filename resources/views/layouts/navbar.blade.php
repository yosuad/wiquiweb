   ...
   <header class="navbar">
       <div class="navbar__container">
           ...
           <div class="navbar__menu">
               <nav class="navbar__nav">
                   <ul class="navbar__list">
                       <li class="navbar__item"><a href="{{ url('/') }}" class="navbar__link">inicio</a></li>
                       <li class="navbar__item"><a href="{{ url('nosotros') }}" class="navbar__link">nosotros</a></li>
                       <li class="navbar__item navbar__item--has-children">
                           <a href="#" class="navbar__link">servicios</a>
                           <ul class="navbar__submenu">
                               <li class="navbar__submenu-item"><a href="blog-details.html"
                                       class="navbar__submenu-link">correos</a></li>
                               <li class="navbar__submenu-item"><a href="portfolio-details.html"
                                       class="navbar__submenu-link">diseño</a></li>
                               <li class="navbar__submenu-item"><a href="404.html"
                                       class="navbar__submenu-link">consultoría</a>
                               <li class="navbar__submenu-item"><a href="404.html" class="navbar__submenu-link">diseño
                                       páginas web</a>
                               </li>
                           </ul>
                       </li>
                       <li class="navbar__item"><a href="blog.html" class="navbar__link">portafolio</a></li>
                       <li class="navbar__item"><a href="contact.html" class="navbar__link">blog</a></li>
                       <li class="navbar__item"><a href="contact.html" class="navbar__link">contacto</a></li>
                   </ul>
               </nav>
           </div>
           ...
           <!-- Mobile Menu -->
           <!-- Botón animacion menu amburgueza -->
           ...
           <nav class="navbar__mobile" aria-label="Menú móvil">
               <ul class="navbar__mobile-list">
                   <li class="navbar__mobile-item">
                       <a href="{{ url('start') }}" class="navbar__mobile-link">inicio</a>
                   </li>
